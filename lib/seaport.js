...
var OpenSeaPort = /** @class */ (function () {
    ...
    OpenSeaPort.prototype.createBuyOrder = function (_a) {
        var asset = _a.asset, accountAddress = _a.accountAddress, startAmount = _a.startAmount, _b = _a.quantity, quantity = _b === void 0 ? 1 : _b, _c = _a.expirationTime, expirationTime = _c === void 0 ? 0 : _c, paymentTokenAddress = _a.paymentTokenAddress, sellOrder = _a.sellOrder, referrerAddress = _a.referrerAddress, signCallback = _a.signCallback;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        _d.trys.push([3, 8, , 9]);
                        if (!signCallback) return [3 /*break*/, 5];
                        return [4 /*yield*/, signCallback(hashedOrder.hash)];
                    case 4:
                        signature = _d.sent();
                        signature = (0, utils_1.parseSignatureHex)(signature);
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this._authorizeOrder(hashedOrder)];
                    case 6:
                        signature = _d.sent();
                        _d.label = 7;
    ...
    OpenSeaPort.prototype.fulfillOrder = function (_a) {
        var order = _a.order, accountAddress = _a.accountAddress, recipientAddress = _a.recipientAddress, referrerAddress = _a.referrerAddress, atomicMatchCallback = _a.atomicMatchCallback;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._atomicMatch({ buy: buy, sell: sell, accountAddress: accountAddress, metadata: metadata, atomicMatchCallback: atomicMatchCallback })
    ...
    OpenSeaPort.prototype.cancelOrder = function (_a) {
        var order = _a.order, accountAddress = _a.accountAddress, cancelOrderCallback = _a.cancelOrderCallback;
        return __awaiter(this, void 0, void 0, function () {
            var transactionHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (!cancelOrderCallback) return [3 /*break*/, 2];
                        return [4 /*yield*/, cancelOrderCallback([order.exchange, order.maker, order.taker, order.feeRecipient, order.target, order.staticTarget, order.paymentToken], [order.makerRelayerFee, order.takerRelayerFee, order.makerProtocolFee, order.takerProtocolFee, order.basePrice, order.extra, order.listingTime, order.expirationTime, order.salt], [order.feeMethod,
                                order.side,
                                order.saleKind,
                                order.howToCall,
                                order.calldata,
    ...
    OpenSeaPort.prototype._atomicMatch = function (_a) {
        var buy = _a.buy, sell = _a.sell, accountAddress = _a.accountAddress, _b = _a.metadata, metadata = _b === void 0 ? constants_1.NULL_BLOCK_HASH : _b, atomicMatchCallback = _a.atomicMatchCallback;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 7:
                        ...
                        if (!atomicMatchCallback) return [3 /*break*/, 9];
                        return [4 /*yield*/, atomicMatchCallback(args, txnData)];

...
var OpenSeaAPI = /** @class */ (function () {
     ...
     * `limit` and `offset` attributes from OrderQuery
     */
    OpenSeaAPI.prototype.getEvents = function (query, page) {
        if (query === void 0) { query = {}; }
        if (page === void 0) { page = 1; }
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.get(constants_1.API_PATH + "/events/", __assign({ limit: this.pageSize, offset: (page - 1) * this.pageSize }, query))];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.asset_events || []];
                }
            });
        });
    };
